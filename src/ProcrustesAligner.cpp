...
Matrix4f ProcrustesAligner::estimatePose(
...
Matrix3f ProcrustesAligner::estimateRotation(
    const std::vector<Vector3f> &sourcePoints, const Vector3f &sourceMean,
...
Vector3f ProcrustesAligner::computeTranslation(const Vector3f &sourceMean,
