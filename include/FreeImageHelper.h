...
struct FreeImage {
    FreeImage();
    FreeImage(unsigned int width, unsigned int height,
    ...
    bool LoadImageFromFile(const std::string& filename, unsigned int width = 0,
...
struct FreeImageB {
    FreeImageB();
    FreeImageB(unsigned int width, unsigned int height,
               unsigned int nChannels = 4);
